...
const providerForm = getElement("provider-form");
...
const providerAuthKindInput = getElement("provider-auth-kind");
...
function showAddProviderForm() {
    const apiKeyInput = getElement("provider-api-key");
    ...
    showProviderForm();
    const nameInput = getElement("provider-name");
    nameInput.focus();
}
